        ...
        <Modal.Root isActive={modalPassword}>
          ...
          <Modal.Context >
            <div>
              ...
              <Input type="password" {...form.register("newPassword")} label="Nova senha" placeholder="Digite sua nova senha" textLabel="Mínimo de 6 dígitos" autoComplete="oldPassword" />
            </div>
          </Modal.Context>
