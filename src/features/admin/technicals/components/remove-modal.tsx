...
import { removeTechnical } from "../http/use-remove-technical"
...
export const ModalRemovetechnicals = ({ userId, modalRemove, setModalRemove }: ModalUpdateCustomerType) => {
  const { data, error, isSuccess, isError, mutateAsync: onRemove, isPending } = removeTechnical()
