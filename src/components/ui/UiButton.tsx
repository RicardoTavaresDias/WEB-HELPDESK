...
type VariantProps = {
  ...
  typeSize: "base" | "xxs" | "xs" | "md" | "lg" | "xl" | "xxl" | "customized"
...
const variant = {
  size: {
    ...
    customized: " w-42 h-11 rounded-md flex justify-center"
  },
  typeColor: {
...
export function UiButton({children, typeColor, typeSize, color = "#535964", icon: Icon, ...props}: VariantProps){
  return (
    <>
      <button className={
        "Text-Sm flex items-center gap-1.5 cursor-pointer hover:shadow-lg transition-shadow" + 
